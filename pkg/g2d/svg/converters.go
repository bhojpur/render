...
func toSvgFillRule(rule d2d.FillRule) string {
	return map[d2d.FillRule]string{
		d2d.FillRuleEvenOdd: "evenodd",
		d2d.FillRuleWinding: "nonzero",
	}[rule]
}

func toSvgPathDesc(p *d2d.Path) string {
...
func toSvgTransform(mat d2d.Matrix) string {
	if mat.IsIdentity() {
		return ""
	}
