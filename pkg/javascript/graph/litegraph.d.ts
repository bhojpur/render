...
/** https://docs.bhojpur.net/litegraph/guides/README.md#lgraphnode */
export declare class LGraphNode {
    ...
    /**
     * https://docs.bhojpur.net/litegraph/guides/README.md#node-widgets
    ...
    // https://docs.bhojpur.net/litegraph/guides/README.md#custom-node-appearance
    onDrawBackground?(
        ctx: CanvasRenderingContext2D,
    ...
    // https://docs.bhojpur.net/litegraph/guides/README.md#custom-node-behaviour
    onMouseDown?(
        event: MouseEvent,
        pos: Vector2,
        graphCanvas: LGraphCanvas
