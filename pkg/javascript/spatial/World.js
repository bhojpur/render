...
// Pretty much any event someone using spatial would need will be emitted or
...
class World extends EventEmitter {
  ...
  _initAttribution() {
    var message = '<a href="https://www.bhojpur-consulting.com" target="_blank">Powered by Bhojpur Render</a>';

    var element = document.createElement('div');
    element.classList.add('bhojpur-attribution');
