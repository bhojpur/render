/* The Core is in charge of launching the application, loading any external
 JS file and register modules, it also handles user preferences */
var CORE = {
	...
	showLoadingPopup: function( imports )
	{
		...
		element.innerHTML = "<div class='title'><img src='https://static.bhojpur.net/image/logo.png' /></div><div class='loader'></div><div class='log'></div>";
