var CodingModule = //do not change
{
	...
	component_help_url: "http://docs.bhojpur.net/litescene/classes/LS.Components.",
	...
	init: function()
	{
		...
		LiteGUI.menubar.add("Help/Coding/LS/Guides", {  callback: function(){ window.open("https://docs.bhojpur.net/litescene/guides#guide-to-develop-for-litescene","_blank"); }});
		LiteGUI.menubar.add("Help/Coding/LS/API", {  callback: function(){ window.open("http://docs.bhojpur.net/litescene/","_blank"); }});
		LiteGUI.menubar.add("Help/Coding/LiteGL/Guides", {  callback: function(){ window.open("https://docs.bhojpur.net/litegl/guides","_blank"); }});
		LiteGUI.menubar.add("Help/Coding/LiteGL/API", {  callback: function(){ window.open("http://docs.bhojpur.net/litegl/","_blank"); }});
	...
	showCodingHelp: function( options )
	{
		...
		if(!help)
		{
			if(options.type === LS.TYPES.COMPONENT)
				window.open( "https://docs.bhojpur.net/litescene/guides/scripting.md"	);
...
LS.Script.templates.component = "//https://docs.bhojpur.net/litescene/guides/programming_components.md\n\
